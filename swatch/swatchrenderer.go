...
type SwatchRenderer struct {
	...
	parent  *Swatch // Need this to determine if something is selected
}
...
// Resize existing color square to maximum size available
...
func (renderer *SwatchRenderer) Refresh() {
	...
	// Indicate to user that the current color Swatch is selected and re-draw
